// Do uu tien: '( )' < '+ -' < '* /' < '^'
// Neu do uu tien cua dinh stack >= do uu tien cua token ==> push dinh stack vao queue 
// tru dau '(' thi dua thang vao stack va neu la dau ')' thi ta se lay no ra cho den khi gap '('
#include<iostream>
#include <string>
using namespace std;

// Node infix to postfix
struct Node{
    char data;
    Node *pLink;
};
//Khai bao mot stack co kieu con tro
typedef Node *STACK;
